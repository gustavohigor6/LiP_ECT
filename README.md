...
## 📖 Descrição
Repositório destinado aos exercícios e projetos da disciplina de **Linguagem de Programação (Python)** do curso de Ciências e Tecnologia da **UFRN**.
Aqui estão solucionados problemas de lógica, estruturas de dados e algoritmos.
